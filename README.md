...
apt install curl dnsutils gnupg2 materia-gtk-theme neofetch x11-utils sshfs mesa mesa-utils picom feh vim autorandr arandr ranger fwupd network-manager-gnome virt-manager xclip
